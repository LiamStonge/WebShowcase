...
const BentoTilt = (props: { children: React.ReactNode; className: string }) => {
    const [transformStyle, setTransformStyle] = useState('');
    const itemRef: React.RefObject<HTMLDivElement | null> = useRef(null);
...
export const Features = (props: FeatureData[]) => {
    return (
